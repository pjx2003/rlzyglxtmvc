...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/worker/registers" method="post">
        ...
        <div class="form-group">
            <label>手机：</label>
            <input type="text" class="form-control" id="phone" name="phone" placeholder="请输入手机号码" required/>
        </div>
